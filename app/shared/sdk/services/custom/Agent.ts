...
export class AgentApi extends BaseLoopBackApi {
  ...
  /**
   * Demandes accessTokens de Agent.
   *
   * @param {any} id Agent id
   *
   * @param {object} filter 
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Agents" + "/:id";
   ...
   * call to {@link sdk.Agent#login} or
   * {@link sdk.Agent#getCurrent}. Return null when there
  ...
  /**
   * @name sdk.Agent#isAuthenticated
   *
