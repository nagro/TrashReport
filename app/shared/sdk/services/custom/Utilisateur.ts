...
/**
 * Api services for the `Utilisateur` model.
 */
@Injectable()
export class UtilisateurApi extends BaseLoopBackApi {
  ...
  /**
   * Demandes accessTokens de Utilisateur.
   *
   * @param {any} id Utilisateur id
   *
   * @param {object} filter 
  ...
  /**
   * Compte accessTokens de Utilisateur.
   *
   * @param {any} id Utilisateur id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Utilisateurs/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.Utilisateur#getCurrent
   * @methodOf sdk.Utilisateur
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Utilisateurs" + "/:id";
   ...
   * call to {@link sdk.Utilisateur#login} or
   * {@link sdk.Utilisateur#getCurrent}. Return null when there
   ...
   * call to {@link sdk.Utilisateur#login}
   *
  ...
  /**
   * @name sdk.Utilisateur#isAuthenticated
   *
  ...
  /**
   * @name sdk.Utilisateur#getCurrentId
   *
